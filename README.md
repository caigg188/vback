...
```bash
curl -fsSL https://raw.githubusercontent.com/yourname/vback/main/vback.sh -o vback.sh && chmod +x vback.sh && ./vback.sh
```
...
```bash
# 下载
wget https://raw.githubusercontent.com/yourname/vback/main/vback.sh
